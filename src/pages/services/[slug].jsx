...
export default function ServiceDetail(meta,url) {
  ...
  let slug = pathname?.replace("/services/", "").split("?")[0];
  console.log(slug);
  ...
  return (
    ...
    <Seo meta={meta} url={url} />
      <HeaderOne />
      <main>
        <Breadcrumb top_title="Blog Details" page_title="Service Details" />
        <section className="postbox__area pt-120 pb-100">
          ...
          dangerouslySetInnerHTML={{
            __html: data?.ContentHtml || "<p>No content available</p>",
          }}
